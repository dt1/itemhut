insert into amazon_office.valid_related_product_id_type values
('GCID'),
('ASIN'),
('EAN'),
('UPC'),
...
insert into amazon_office.valid_battery_type values
('battery_type_d'),
('battery_type_a'),
('battery_type_c'),
...
insert into amazon_office.valid_item_weight_unit_of_measure values
('LB'),
('KG'),
('GR'),
('OZ');

insert into amazon_office.valid_update_delete values
('Update'),
('PartialUpdate'),
('Delete');
