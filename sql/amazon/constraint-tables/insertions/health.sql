...
insert into amazon_health.valid_battery_type values
('battery_type_d'),
('battery_type_a'),
('battery_type_c'),
...
insert into amazon_health.valid_update_delete values
('Update'),
('PartialUpdate'),
('Delete');
...
insert into amazon_health.valid_missing_keyset_reason values
('NonConsumer'),
('Specialized'),
('PrivateLabel'),
('PreConfigured');
